...
class AnimeRecommender :
    def __init__(self):    
        ...
        self.anime_df = self.anime_df[(self.anime_df["Score"] != "Unknown") ] 
    ...
    def content(self,title):  
        ...
        anime_lst = self.anime_df.iloc[anime_indices][['MAL_ID','Name', 'Members', 'Score','Genres','Popularity']]
    ...
    def hybrid(self,user_id,title):
        ...
        id_map = id_map.merge(self.anime_df[['MAL_ID','Name', 'Members', 'Score','Genres','Popularity']], on='MAL_ID').set_index('Name')   
        ...
        result = qualified[['MAL_ID','Name', 'Members', 'Score','Genres','Popularity']]
